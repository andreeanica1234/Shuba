...
public class MyGithubContentProvider extends ContentProvider {
     ...
     */
    public MyGithubContentProvider() {
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        long id;
        Uri modifiedUri = MyGithubContentProvider.CONTENT_URI;
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case Entities.USER: {
                ...
                String sqlSelection = " AND " + DbContract.User.ID + "=" + uri.getLastPathSegment();
                cursor = mySqlHelper.getReadableDatabase().query(DbContract.User.TABLE,
            ...
            case Entities.GROUP: {
                ...
                String sqlSelection = " AND " + DbContract.Group.ID + "=" + uri.getLastPathSegment();
                cursor = mySqlHelper.getReadableDatabase().query(DbContract.Group.TABLE,
            ...
            case Entities.TASK: {
                // Building upon the selection to just choose the corresponding profile
                String sqlSelection = " AND " + DbContract.Task.ID + "=" + uri.getLastPathSegment();
                cursor = mySqlHelper.getReadableDatabase().query(DbContract.Task.TABLE,
                        projection, (TextUtils.isEmpty(selection) ? "1" : selection)
                                + sqlSelection, selectionArgs, null, null, sortOrder);
                break;
